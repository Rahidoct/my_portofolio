...
const sendEmail = (e) =>{
    ...
    if(contactName.value === '' || contactEmail.value === '' || contactProject.value === ''){
        ...
        // hapus semua input yang sudah dikirim
        contactName.value = ''
        contactEmail.value = ''
...
sr.reveal('.skills__content:nth-child(1), .contact__container:nth-child(1)', {origin: 'left'})
